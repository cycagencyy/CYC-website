      ...
      <section id="hero" className="min-h-screen bg-gradient-to-br from-cyc-purple via-cyc-purple-light to-cyc-purple-dark text-white relative overflow-hidden" style={{
        ...
        <div className="w-full text-center relative z-10 flex flex-col justify-center min-h-screen px-8 pt-24">
          ...
          >
            ...
            <motion.h1 
              className="hero-title text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-bold mb-6 md:mb-8 leading-tight tracking-tight text-center px-4"
        ...
        <div className="w-full px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center px-4">
            <Link to="/contact" className="w-full sm:w-auto">
              <motion.div 
                className="bg-gradient-to-r from-cyc-yellow via-yellow-400 to-cyc-yellow text-cyc-purple px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold text-base sm:text-lg hover:from-yellow-300 hover:via-yellow-300 hover:to-yellow-300 transition-all duration-300 shadow-lg hover:shadow-xl text-center"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.2 }}
                viewport={{ once: true }}
            ...
            >
              <motion.div 
                className="bg-green-500 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold text-base sm:text-lg hover:bg-green-600 transition-all duration-300 shadow-lg hover:shadow-xl text-center flex items-center justify-center space-x-2"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.3 }}
                viewport={{ once: true }}
              ...
              >
                ...
                <span>{language === 'en' ? 'WhatsApp Us' : 'تواصل عبر WhatsApp'}</span>
              </motion.div>
            </a>
          </div>
        </div>
