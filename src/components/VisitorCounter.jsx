...
function VisitorCounter() {
  ...
  return (
    <div className="flex items-center space-x-2 text-xs sm:text-sm bg-white/5 dark:bg-gray-800/30 backdrop-blur-sm rounded-md px-2 py-1 border border-white/10 dark:border-gray-700/30">
